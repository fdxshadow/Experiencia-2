            ...
            <div class="container-fluid">
              <div class="panel panel-primary">
               <div class="panel-heading">
                <h3 class="panel-title">Datos que ingresaste</h3>
              </div>
             <div class="panel-body">
                    <p>
                        Muchas gracias, <?php echo $nombre." ".$apellido; ?> <br>
                        <li>Fecha de nacimiento: <?php echo $fecha; ?> </li>
                        <li>Sexo: <?php echo $sexo; ?> </li>
                        <li>Region: <?php echo $region; ?></li>
                        <li>Areas de interes : <?php 
                            if($deporte!=''){
                                echo $deporte." ";
                         ...
                         ?> </li>
                        <li> Pagina personal : <?php echo $pagina; ?> </li>
                        <li> Correo electronico : <?php echo $correo; ?> </li>
                        <li> Color Favorito : <?php echo $color; ?> </li>
